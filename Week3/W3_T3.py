...
# Creating menus like this is a really handy way to make tiny text-based 
# programs and there will be more exercises like this in the future.
# The expectation at this point is that the user is able to choose option by 
# inserting corresponding number. 
